  ...
  return (
    <div className="flex flex-col top-0 left-0 w-[13rem] h-[20rem] bg-transparent border-2 border-gray-300 rounded py-[1.2rem] px-[0.8rem] text-center">
      ...
      <Link
        ...
        className="flex items-center justify-center text-sm text-center mt-3.5 mb-3.5 bg-gray-300 hover:bg-[#3A3A3A] rounded-full w-[7rem] h-[0.7rem] py-[0.6rem] px-[0.1rem]"
      >
      ...
      <Link
        ...
        className="flex items-center justify-center text-sm mb-3.5 bg-gray-300 hover:bg-[#3A3A3A] rounded-full w-[7rem] h-[0.7rem] py-[0.6rem] px-[0.1rem]"
      >
      ...
      <Link
        href="/categories/go"
        className="flex items-center justify-center text-sm mb-3. bg-gray-300 hover:bg-[#3A3A3A] rounded-full w-[4.5rem] h-[0.7rem] py-[0.6rem] px-[0.1rem]"
      >
