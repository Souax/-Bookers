    ...
    <>
      <div className="relative">
        <div className="absolute mt-[-160rem]">
          <div className="flex">
            <div className="flex flex-col top-0 left-0 w-[13.5rem] h-[27rem] bg-transparent border-2 border-gray-300 rounded py-[1.2rem] px-[0.8rem] text-center">
              ...
              <Link
                ...
                className="flex items-center justify-center text-sm text-center mt-4 mb-4 bg-gray-300 hover:bg-[#3A3A3A] rounded-full w-[11rem] h-[0.7rem] py-[0.8rem] px-[0.1rem]"
              >
              ...
              <Link
                href="/categories/vue"
                className="flex items-center justify-center text-sm mb-4 bg-gray-300 hover:bg-[#3A3A3A] rounded-full w-[11rem] h-[0.7rem] py-[0.8rem] px-[0.1rem]"
              >
