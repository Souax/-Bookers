class Api::V1::BooksController < ApplicationController
    ...
    def base
        ...
        @books.concat(RakutenWebService::Books::Book.search(title: "入門 Ruby", page: page, hits: per).to_a)
        @books.concat(RakutenWebService::Books::Book.search(title: "入門 Python", page: page, hits: per).to_a)
        @books.concat(RakutenWebService::Books::Book.search(title: "入門 Java", page: page, hits: per).to_a)
        @books.concat(RakutenWebService::Books::Book.search(title: "入門 JavaScript", page: page, hits: per).to_a)
        @books.concat(RakutenWebService::Books::Book.search(title: "入門 AWS", page: page, hits: per).to_a)
    ...
    def css
        ...
        @cssbooks.concat(RakutenWebService::Books::Book.search(title: "CSS設計", page: page, hits: per).to_a)
